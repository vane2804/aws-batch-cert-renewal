...
# An SSM Document is run on a specific EC2 instance
...
def start_process():
  instance_id = 'EC2_ID'
  ssm_response = send_command(instance_id)
...
def send_command( instance_id ):
  ...
  try:
    ...
    #   OutputS3BucketName='ymcareers-nginx-scratch'
    )
